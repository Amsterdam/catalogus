...
paster user add employee_plus password=insecure \
                              ...
                              email=not-real@employee_plus.amsterdam.nl -c /app/config.ini

paster user add open password=insecure \
                     name=open \
                     fullname=open \
                     email=not-real@open.amsterdam.nl -c /app/config.ini

paster user add employee password=insecure \
                         name=employee \
                         fullname=employee email=not-real@employee.amsterdam.nl -c /app/config.ini
